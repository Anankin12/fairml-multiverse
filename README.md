...
A script installing `pipenv` at the user level or in the root of this repo which also automatically fetches a version of `Python 3.8` and initializes the `pipenv` in the repo root is provided in [setup_pyenv_3_8.sh](./setup_pyenv_3_8.sh). Run it from the project root.
